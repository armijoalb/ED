...
public:
  ...
  */
  ...
  /**
    @brief Establecer raíz.

    @param e Nuevo valor de la raíz.
  */
  void setRoot( const bintree<T>::node & e);

  /**
    @brief Cambio de bintree por otro.
    @param dest Bintree con el que se cambia.
  */
  void swap( bintree<T> & dest );
 ...
 class inorder_iterator
 {
  ...
  inorder_iterator begin_reverse();
  inorder_iterator end_reverse();
...
class const_inorder_iterator
 {
  ...
  const_inorder_iterator begin_reverse() const;
  const_inorder_iterator end_reverse() const;
